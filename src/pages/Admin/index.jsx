...
const Admin = () => {
  ...
  const handleAddSaldo = async () => {
    if (!selectedUserId || selectedUserId === "-") {
      toast.error("Por favor, selecione um usuário válido para adicionar saldo.");
      return;
    }
  ...
  return (
    <div className={styles.adminContainer}>
      ...
      <p className={styles.welcomeMessage}>Bem-vindo, {user.firstName}! <p className={styles.saldoLabel}>Saldo Atual: {saldo}</p></p>
      ...
      <div className={styles.buttonContainer}>
        <button onClick={handleAddSaldo} disabled={updatingSaldo} className={styles.button}>
